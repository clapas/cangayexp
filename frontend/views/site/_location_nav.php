<?php
    ...
    echo ButtonGroup::widget([
        ...
        'buttons' => [
            ...
            ['label' => 'Maspalomas', 'tagName' => 'a', 'options' => ['href' => Url::to(['offer/maspalomas']), 'class' => 'btn-primary']],
            ['label' => 'Campo de Golf', 'tagName' => 'a', 'options' => ['href' => Url::to(['offer/campo_de_golf']), 'class' => 'btn-primary']],
